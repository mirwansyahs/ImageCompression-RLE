    ...
    <div class="row mt-3">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-text"><?= $detail['namapendata'] ?></p>
                    ...
                    <p class="card-text">ukuran setelah kompresi :
                        <?= $bukti2['compressed_size_r']+$bukti2['compressed_size_g']+$bukti2['compressed_size_b']?></p>
                    <!-- <p class="card-text"><img src="<?= base_url('/') . $detail['bukti3']; ?>"
                            class="card-img"></p> -->
                    <!-- <p class="card-text"><img src="<?= base_url('/') . $detail['bukti4']; ?>"
                            class="card-img">
                    </p> -->
                    <a href="<?= base_url(); ?>data" class="btn btn-warning float-right">Kembali</a>
                </div>
            </div>
        </div>
    </div>
